...
import com.wamcstudios.calorytracker.onboarding.presentation.nutrient.components.NutrientContent

@Composable
fun NutrientScreen(onNavigate: (UiEvent) -> Unit, viewModel: NutrientViewModel = hiltViewModel()) {
