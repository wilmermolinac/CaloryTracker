...
import com.wamcstudios.calorytracker.onboarding.domain.use_cases.LoadShouldShowOnboarding
...
import com.wamcstudios.calorytracker.onboarding.domain.use_cases.SaveShouldShowOnboarding
...
object OnboardingModule {
    ...
    fun providesOnboardingUseCases(preferences: Preferences): OnboardingUseCases {
        return OnboardingUseCases(
            ...
            saveShouldShowOnboarding = SaveShouldShowOnboarding(preferences),
            loadShouldShowOnboarding = LoadShouldShowOnboarding(preferences)
        )
    }
}